...
class PDFParser(object):
    ...
    def parse(self, pdf, owner_password='', user_password=''):
        ...
        # Hooray, metadata in the list part is not the same as the metadata
        # in xml. Uff.
...
#            list_map[k] = v
        ...
        for patt in patt_list:
            ...
            if mobj is not None:
                ...
                # acrobat separates keywords with a semicolon. There is no
                # datatyping so we assume it is a list if a semicolon appears.
                if ";" in value:
                    kw = value.split(";")
        ...
        # If the language is given in the filename extension, we consider
    ...
    def _guessLanguage(self, file):
        ...
        string followed by an _ or at the end of the string prefixed by
        an _ just before the extension
        """
